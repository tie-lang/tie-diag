...
> 每条警告都包含「这样写的坏处」与修复建议。当前编译器发射 W00001..W00004、W00020..W00023；
> 其余（W00005..W00019）为规划中的经验型检查，文档先行。
> Every warning carries why-the-pattern-is-bad plus a fix. W00001..W00004 and
> W00020..W00023 are emitted today; W00005..W00019 are planned checks (docs first).
...
EN: W00001 float == (use eps-range), W00002 int division truncation, W00003 O(n²)
loop string concat (use string_builder), W00004 table var copy shares storage
(use clone), W00020-W00023 role config/registration issues; planned W0005-W0019
